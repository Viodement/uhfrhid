...
public class RecordsBoard {
    ...
    private static RecordsBoard toast;
    ...
    public RecordsBoard(final Activity context, View ll) {
        owner = context;
        toast = this;

        adapterMergedData = new SimpleAdapter(owner, dataMerged, R.layout.common_lv2overlap_tv2, new String[]{"0", "1"},
                new int[]{R.id.idE2CommenLv2OverlapTv1_tv0, R.id.idE2CommenLv2OverlapTv1_tv1});
        //初始化Listview控件
