...
public class Activity0Inventory extends com.senter.demo.uhf.commonActivity.Activity0InventoryCommonAbstract {
    ...
    private ArrayList<UII> startInventoryWithBuffer() throws InterruptedException {
        ...
        UmdOnIso18k6cInventory inventoryLisener = new UmdOnIso18k6cInventory() {
            ...
            public void onSuccessed(Integer antennaId, final int tagCountResult, int readRate, long totalRead) {
                Log.v("", "iso18k6cInventory:onSuccessed antennaId:" + antennaId + " tagCountResult:" + tagCountResult
                        + " readRate:" + readRate + " totalRead:" + totalRead);
                if (tagCountResult != 0) {
                    new Thread() {
                        public void run() {
